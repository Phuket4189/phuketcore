<template>
  <nav class="sidebar">
    <div class="brand"><p>PhuketCore<span class="cursor">_</span></p></div>
    <ul>
...
.sidebar {
  ...
  box-shadow: 2px 0 8px rgba(2,6,23,0.3);
  display: flex;
...
/* 闪烁光标样式 */
.brand p { display: inline-flex; align-items: center; gap: 0.2rem; }
.cursor {
